...
ActiveRecord::Schema.define(version: 2020_05_25_212740) do
  ...
  create_table "join_game_genres", force: :cascade do |t|
    t.string "game"
    t.string "genre"
  end

  create_table "join_game_platforms", force: :cascade do |t|
    t.string "game"
    t.string "platform"
  end
